      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-10">
            ...
            <Link href="/a-propos" className="text-gray-600 hover:text-red-500 transition-colors duration-300 font-light">L'agence</Link>
        ...
        <div className={`md:hidden transition-all duration-300 ease-in-out ${
          ...
          <div className="px-2 pt-2 pb-3 space-y-1 bg-white/95 backdrop-blur-md rounded-lg mt-2 border border-gray-200/50 shadow-lg">
            ...
            <Link href="/a-propos" className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-red-500 hover:bg-gray-50" onClick={() => setIsMenuOpen(false)}>L'agence</Link>
