...
export default async function RessourcesFocusSalesforce({ params }: { params: { locale: string } }) {
  const t = await getTranslations({ locale: params.locale, namespace: 'ResourcesFocusSalesforce' });
