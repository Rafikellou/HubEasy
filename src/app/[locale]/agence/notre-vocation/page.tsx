          ...
          <div className="grid md:grid-cols-2 gap-10">
            ...
            <AnimatedSection animation="fade-up" delay={200}>
              <div className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 h-full flex flex-col">
                <div className="flex items-center gap-6 mb-6">
                  <div className="relative w-24 h-24 rounded-full overflow-hidden shadow-md">
                    <Image src="/images/ahmed-photo.png" alt={t('ahmed_alt')} fill className="object-cover object-[center_30%]" quality={95} />
                  </div>
                  <div>
                    <h3 className="text-2xl font-light text-gray-900">{t('ahmed_name')}</h3>
                    <p className="text-red-500 font-medium">{t('ahmed_role')}</p>
                  </div>
                </div>
                <ul className="space-y-3 font-light text-gray-700">
                  <li className="flex items-center"><CheckCircle className="w-5 h-5 text-red-500 mr-3 flex-shrink-0" /><span>{t('ahmed_exp1')}</span></li>
                  <li className="flex items-center"><CheckCircle className="w-5 h-5 text-red-500 mr-3 flex-shrink-0" /><span>{t('ahmed_exp2')}</span></li>
                  <li className="flex items-center"><CheckCircle className="w-5 h-5 text-red-500 mr-3 flex-shrink-0" /><span>{t('ahmed_exp3')}</span></li>
                </ul>
              </div>
            </AnimatedSection>
          </div>
